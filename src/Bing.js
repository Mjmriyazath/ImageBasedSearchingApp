...
import Bing from './bing.svg'; // make sure you have the Google logo image in the specified path
...
const GoogleButton = () => {
  ...
  return (
    <button onClick={handleClick} style={{ display: 'flex', alignItems: 'center', padding: '10px', borderRadius: '5px', border: '1px solid #ddd', backgroundColor: '#fff' }}>
      <img src={Bing} alt="Google Logo" style={{ width: '20px', height: '20px', marginRight: '10px' }} />
      View Result from Bing
    </button>
  );
};
